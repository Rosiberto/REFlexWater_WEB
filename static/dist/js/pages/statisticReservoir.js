var idarray = [], chartData = [],
  ...
  function Min(id){
    var request2 = $.ajax({
      type: "GET",
      url:  "api/v1/min/"+ id +"/Reservoir/Pressure/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Med(id){
    var request3 = $.ajax({
      type: "GET",
      url:  "api/v1/avg/"+ id +"/Reservoir/Pressure/day",
      dataType: "json",
      async: false,
    });
  ...
  function Max(id){
    var request4 = $.ajax({
      type: "GET",
      url:  "api/v1/max/"+ id +"/Reservoir/Pressure/day",
      dataType: "json",
      async: false,
    });
  ...
  function Bruto(id){
    ...
    var request5 = $.ajax({
        type: "GET",
        url:  "api/v1/raw/"+ id +"/Reservoir/Pressure/0",
        dataType: "json",        
        async: false,
    });
    $.when(request5).done(function(result5){
        ...
        for (var i in result5){
          ...
          g = new Dygraph(document.getElementById("rowGraphReservoir"+id),chartData,{ylabel: 'Pressure (mca)', labels: ['Tempo','Pressão']
                    , title: 'Consumo Geral', rollPeriod: 1, drawPoints: true});
  ...
  function criaCard(min, med, max){
    ...
    var divCol, divCard, divCardHeader, divCardBody, 
        ...
        divChartReservoir, divCardFooter, divRowFooter, 
    ...
    divCardHeader.innerHTML="<h5 class='card-title'><strong>Reservatório - "+idarray[j]+"</strong></h5>";
    ...
    divChartReservoir = document.createElement("div");
    divChartReservoir.setAttribute('id', 'rowGraphReservoir'+idarray[j]);
    divChartReservoir.setAttribute('style','height: 180px');
    ...
    divChart.appendChild(divChartReservoir);
    ...
    document.getElementById("rowReservoir").appendChild(divCol);     
