 var idarray = [], chartData = [],
  ...
  function Min(id){
    var request2 = $.ajax({
      type: "GET",
      url:  "api/v1/min/"+ id +"/Tank/Pressure/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Med(id){
    var request3 = $.ajax({
      type: "GET",
      url:  "api/v1/avg/"+ id +"/Tank/Pressure/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Max(id){
    var request4 = $.ajax({
      type: "GET",
      url:  "api/v1/max/"+ id +"/Tank/Pressure/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Bruto(id){
    ...
    var request5 = $.ajax({
        type: "GET",
        url:  "api/v1/raw/"+ id +"/Tank/Pressure/0",
        dataType: "json",        
        async: false,
    });
    $.when(request5).done(function(result5){
        ...
        for (var i in result5){
          ...
          g = new Dygraph(document.getElementById("rowGraphTank"+id),chartData,{ylabel: 'Pressure (mca)', labels: ['Tempo','Pressão']
  ...
  function criaCard(min, med, max){
    ...
    var divCol, divCard, divCardHeader, divCardBody, 
        ...
        divChartTank, divCardFooter, divRowFooter, 
    ...
    divCardHeader.innerHTML="<h5 class='card-title'><strong>Tanque - "+idarray[j]+"</strong></h5>";
    ...
    divChartTank = document.createElement("div");
    divChartTank.setAttribute('id', 'rowGraphTank'+idarray[j]);
    divChartTank.setAttribute('style','height: 180px');
    ...
    divChart.appendChild(divChartTank);
    ...
    document.getElementById("rowTank").appendChild(divCol);     
  }