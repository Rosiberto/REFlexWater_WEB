 var idarray = [], chartData = [],
  ...
  function Min(id){
    var request2 = $.ajax({
      type: "GET",
      url:  "api/v1/min/"+ id +"/Valve/Flow/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Med(id){
    var request3 = $.ajax({
      type: "GET",
      url:  "api/v1/avg/"+ id +"/Valve/Flow/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Max(id){
    var request4 = $.ajax({
      type: "GET",
      url:  "api/v1/max/"+ id +"/Valve/Flow/day",
      dataType: "json",      
      async: false,
    });
  ...
  function Bruto(id){
    ...
    var request5 = $.ajax({
        type: "GET",
        url:  "api/v1/raw/"+ id +"/Valve/Flow/0",
        dataType: "json",
        async: false,
    });
    $.when(request5).done(function(result5){
        ...
        for (var i in result5){
          ...
          g = new Dygraph(document.getElementById("rowGraphValve"+id),chartData,{ylabel: 'Flow (l/s)', labels: ['Tempo','Vazão']
  ...
  function criaCard(min, med, max){
    ...
    var divCol, divCard, divCardHeader, divCardBody, 
        ...
        divChartValve, divCardFooter, divRowFooter, 
    ...
    divCardHeader.innerHTML="<h5 class='card-title'><strong>Válvula - "+idarray[j]+"</strong></h5>";
    ...
    divChartValve = document.createElement("div");
    divChartValve.setAttribute('id', 'rowGraphValve'+idarray[j]);
    divChartValve.setAttribute('style','height: 180px');
    ...
    divChart.appendChild(divChartValve);
    ...
    document.getElementById("rowValve").appendChild(divCol);     
  }
